      ...
      <div class="row">
        ...
        <div class="card-consultar-chamado">
          <div class="card">
			...
			<?
			//pecorrendo todos os indices do array $chamados sendo atribuido a uma nova variavel $chamado
			foreach($chamados as $chamado) {?>

			<?php
				//indices sendo quabrados em partes pelo denominador #
				$chamado_dados = explode('#', $chamado);

				
				//contagem de elemntos do array
			...
			?>
				<div class="card mb-3 bg-light">
					<div class="card-body">
					<h5 class="card-title" style="text-transform:capitalize;"><?= $chamado_dados[1];?></h5>
